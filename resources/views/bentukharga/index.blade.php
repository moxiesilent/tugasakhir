                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                            <a class="dropdown-item btn btn-primary btn-sm" href="{{url('bentukhargas/'.$d->idbentukharga.'/edit')}}">&nbsp&nbsp&nbspUbah</a>
                                            <form method="post" action="{{url('bentukhargas/'.$d->idbentukharga)}}">
                                                @csrf
                                                @method('DELETE')
