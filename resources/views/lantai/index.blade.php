                    ...
                    <table id="myTable" class="table table-striped" style="width:100%; ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$d->nama}}</td>
                                <td>
                                    <a href="{{url('lantais/'.$d->idjenis_lantai.'/edit')}}"><button class="btn btn-warning btn-sm p-2"><i data-feather="edit"></i></button></a>
                                    <button class="btn btn-danger btn-sm p-2"><i data-feather="trash-2" onclick="hapus('{{csrf_token()}}','{{$d->idjenis_lantai}}')"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
