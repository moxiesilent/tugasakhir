                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                            <a class="dropdown-item btn btn-primary btn-sm" href="{{url('lantais/'.$d->idjenis_lantai.'/edit')}}">&nbsp&nbsp&nbspUbah</a>
                                            <form method="post" action="{{url('lantais/'.$d->idjenis_lantai)}}">
                                                @csrf
                                                @method('DELETE')
                                                <input class="dropdown-item btn btn-danger btn-sm" type="submit" value="Hapus" onclick="if(!confirm('apakah anda yakin menghapus data ini?')) return false;">
                                            </form>
                                        </div>
                                    </div>
                                </td>
