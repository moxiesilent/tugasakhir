                    ...
                    <table id="myTable" class="table table-striped" style="width:100%; ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('laporans/'.$d->idlaporan)}}"><button class="btn btn-primary btn-sm p-2"><i data-feather="eye"></i></button></a>
                                    <a href="{{url('laporans/'.$d->idlaporan.'/edit')}}"><button class="btn btn-warning btn-sm p-2"><i data-feather="edit"></i></button></a>
                                    <button class="btn btn-danger btn-sm p-2"><i data-feather="trash-2" onclick="hapus('{{csrf_token()}}','{{$d->idlaporan}}')"></i></button>
                                </td>
