                    ...
                    <table id="myTable" class="table table-striped" style="width:100%; ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('tipepropertis/'.$d->idtipe_properti.'/edit')}}"><button class="btn btn-warning btn-sm p-2"><i data-feather="edit"></i></button></a>
                                    <button class="btn btn-danger btn-sm p-2"><i data-feather="trash-2" onclick="hapus('{{csrf_token()}}','{{$d->idtipe_properti}}')"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="{{url('tipepropertis')}}">
            @csrf
                ...
                <div class="row">
                    <div class="col-lg-6 col-12 mx-auto">
                        <div class="form-group">
                            <label for="jenisproperti">Tipe Properti</label>
                            <input id="jenisproperti" type="text" name="jenisproperti" placeholder="Tipe properti..." class="form-control" required>
                        </div>
                    </div>                                        
                </div>
            </div>
